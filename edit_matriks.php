        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include 'topbar.php'; 
                ...
                if(isset($_POST['submit'])){
                    ...
                    $sql = "UPDATE sampel SET nilai='$nilai' WHERE id_sampel='".$_REQUEST['id_sampel']."'";
                    $result = mysqli_query($mysqli, $sql);
                    if ($result) {
                        echo "<div class='row'>";
                        echo "<div class='col-sm-8'></div>";
                        echo "<div class='col-sm-4 text-right alert alert-success alert-dismissible fade show'>Nilai Matriks Berhasil Diubah!</div>";
                        echo "</div>";
                        echo "</div>";
                    } else {
                        echo "<script>
                ...
                JOIN kriteria ON sampel.id_kriteria = kriteria.id_kriteria limit 0,1";
            ...
            ?>
                ...
                <div class="container-fluid">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Ubah Nilai Matriks</h1>
                    </div>
                                ...
                                <div class="card-body">
                                    <form method="POST" action="#" enctype="multipart/form-data">
                                        <div class="form-group">
                                            <label for="nama_alternatif">Alternatif</label>
                                            <input type="text" disabled="disabled" value='<?php echo $nama_alternatif; ?>' name="nama_alternatif" id="nama_alternatif" required="required" placeholder="ketik" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="nama_kriteria">Kriteria</label>
                                            <input type="text" disabled="disabled" value='<?php echo $nama_kriteria; ?>'  name="nama_kriteria" id="nama_kriteria" required="required" placeholder="ketik" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <label for="nilai">Nilai Matriks</label>
                                            <input type="number" value='<?php echo $nilai; ?>' name="nilai" id="nilai" required="required" placeholder="ketik" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <button type="submit" class="btn btn-sm btn-success" name="submit"><i class="fa fa-plus"></i> Ubah</button>
                                            <button type="reset" class="btn btn-sm btn-danger"><i class="fa fa-times"></i> Batal</button>
                                            <a href='matriks.php' class='btn btn-sm btn-info'><i class='fas fa-caret-left'></i> Back</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
