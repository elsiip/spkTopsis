            ...
            <?php include 'topbar.php'; 
                ...
                if(isset($_POST['submit'])){
                    ...
                    if ($result) {
                        ...
                        echo "<div class='col-sm-4 text-right alert alert-success alert-dismissible fade show'>Alternatif Baru Ditambahkan!</div>";
                        echo "</div>";
                        echo "</div>";
                    } else {
                        echo "<script>
                                ...
                                <div class="card-body">
                                    <form method="POST" action="#" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nama_alternatif" id="nama_alternatif" required="required" placeholder="ketik" autocomplete="off" class="form-control">
                                        </div>
                                        <div class="form-group">
